    ...
    with torch.no_grad():
        ...
        for i in range(0, data_source.size(0) - 1, seq_len):
            ...
            for j in range(batch_size):
                ...
                #df_future = df_future # no ranking # 0.7977868975612563
                #df_future = df_future.sample(frac=1) #random 0.7787248338261271 0.7977868975612563
                #df_future = df_future.sort_values (by = 'skip_info',ascending=False) # worst 0.6790635751250348
