...
def get_data(batch_size):
    ...
    train_data = input[0:6000].long()
    val_data = input[6000:7500].long()
    test_data = input[7500:8395].long()
    ...
    train_label = label[0:6000].long()
    val_label = label[6000:7500].long()
    test_label = label[7500:8395].long()
