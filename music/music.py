...
# load data and label
train_data_raw,val_data_raw,test_data_raw,train_label,val_label,test_label = get_data(args.batch_size)
...
train_data = convert_to_index(train_data_raw, track_dic).long()[0:150]
val_data = convert_to_index(val_data_raw, track_dic).long()[0:150]
test_data = convert_to_index(test_data_raw, track_dic).long()[0:150]
